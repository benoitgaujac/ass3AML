...
xaxis = perfs_30{:,1};
perfs_30     = perfs_30{:,:};
mov_perfs_30 = tsmovavg(perfs_30,'s',10,1);
perfs_100    = perfs_100{:,:};
mov_perfs_100 = tsmovavg(perfs_100,'s',10,1);
perfs_1000   = perfs_1000{:,:};
mov_perfs_1000 = tsmovavg(perfs_1000,'s',10,1);
perfs_replay = perfs_replay{:,:};
mov_perfs_replay = tsmovavg(perfs_replay,'s',10,1);
perfs_target = perfs_target{:,:};
mov_perfs_target = tsmovavg(perfs_target,'s',10,1);
perfs_double = perfs_double{:,:};
mov_perfs_double = tsmovavg(perfs_double,'s',10,1);
