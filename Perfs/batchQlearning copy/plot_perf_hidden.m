perfs_05     = readtable('perf_hidden_0.5.csv');
perfs_01     = readtable('perf_hidden_0.1.csv');
perfs_001    = readtable('perf_hidden_0.01.csv');
perfs_0001   = readtable('perf_hidden_0.001.csv');
perfs_00001  = readtable('perf_hidden_0.0001.csv');
perfs_000001 = readtable('perf_hidden_1e-05.csv');
xaxis = perfs_00001{:,1};
perfs_05     = perfs_05{:,:};
perfs_01     = perfs_01{:,:};
perfs_001    = perfs_001{:,:};
...
losses_05     = readtable('losses_hidden_0.5.csv');
losses_01     = readtable('losses_hidden_0.1.csv');
losses_001    = readtable('losses_hidden_0.01.csv');
losses_0001   = readtable('losses_hidden_0.001.csv');
losses_00001  = readtable('losses_hidden_0.0001.csv');
losses_000001 = readtable('losses_hidden_1e-05.csv');
...
hold off;
saveas(f1,'plots/loss_hidden.jpg')
...
hold off;
saveas(f2,'plots/len_hidden.jpg')
...
hold off;
saveas(f3,'plots/returns_hidden.jpg')
...
saveas(f4,'plots/hidden_meanl_5.jpg')
...
ylabel('episode lenght') % y-axis label
legend('Mean lentgh', 'std lentgh','std lentgh', 'Location','best')
saveas(f5,'plots/hidden_meanl_1.jpg')
...
ylabel('episode lenght') % y-axis label
legend('Mean lentgh', 'std lentgh','std lentgh', 'Location','best')
saveas(f6,'plots/hidden_meanl_01.jpg')
...
ylabel('episode lenght') % y-axis label
legend('Mean lentgh', 'std lentgh','std lentgh', 'Location','best')
saveas(f7,'plots/hidden_meanl_001.jpg')
...
ylabel('episode lenght') % y-axis label
legend('Mean lentgh', 'std lentgh','std lentgh', 'Location','best')
saveas(f8,'plots/hidden_meanl_0001.jpg')
...
ylabel('episode lenght') % y-axis label
legend('Mean lentgh', 'std lentgh','std lentgh', 'Location','best')
saveas(f9,'plots/hidden_meanl_00001.jpg')
